          ...
          <Card style={{borderRadius:"15px"}} className='col-12 col-lg-11 shadow h-100' >
            ...
            <Card.Body>
                ...
                <Card.Text className='text-secondary pb-0 mb-0'>
                    ...
                    <span style={{textAlign:"justify"}} className='d-block p-0 m-0 text-justify'>{desc} I will Manage Hotels, Resorts, Transports, Tickets and other required things for you.</span>
                    <span className='d-block p-0 m-0 fw-bold'>Duration: <span className='text-primary'>{duration} Days</span></span>
                </Card.Text>
