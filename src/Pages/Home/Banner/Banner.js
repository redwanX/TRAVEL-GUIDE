  ...
  return (
    ...
    text-center text-lg-start align-items-center  justify-content-around '>
      <div className='w-100 bg-white'>
        ...
        <p className='text-justify text-secondary'>I'm one of the best travel guide of Indonesia. I have 1000+ client,They are happy with my services! Are you ready for Your next destination with me?</p>
