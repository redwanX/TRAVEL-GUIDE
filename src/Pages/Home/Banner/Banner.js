...
const Banner = () => {
  return (
     <div className='banner-bg'>
        <div className='mb-5 mt-3 container-lg d-flex flex-lg-row flex-column-reverse
    text-center text-lg-start align-items-center  justify-content-around '>
      <div className='w-100 bg-white'>
        ...
        <p className='text-justify text-secondary'>I'm one of the best travel guide of Indonesia. I have 1000+ client,Whose are happy with my services! Are you ready for Your next destination with me?</p>
